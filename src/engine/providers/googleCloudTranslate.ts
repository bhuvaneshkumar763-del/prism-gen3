 ...
 * User's own API key + billing, same trust tier as the LLM/LibreTranslate-
 * paid providers. Added specifically because it's the closest available
...
const PIECE_PART_SEPARATOR = '␟'; // U+241F — same convention as libretranslate.ts/llm.ts
